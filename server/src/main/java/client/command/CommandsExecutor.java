...
import client.command.commands.gm0.ScrollAllCommand;
import client.command.commands.gm0.SkillLevelCommand;
import client.command.commands.gm0.GodlyCheckCommand;
...
public class CommandsExecutor {
    ...
    private void registerLv0Commands() {
        ...
        addCommand("scroll", ScrollAllCommand.class);
        addCommand("skill", SkillLevelCommand.class);
        addCommand("check", GodlyCheckCommand.class);
